 ...
 * their use of a __builtin_clz() or a cpp::clz() asm intrinsic, this version does
 * everything dependency and architecture-free, except for little-endian assumptions.
 *
   ...
   switch (c_get_f_round()) {
      ...
      case _round_nearest:
         ...
         if ((_y & 3) == 2){ //Tie, round bit set but sticky isn't
            ...
            _y >>= 2;
            _y += _lsb; //Set lsb of _y to zero to make it even
