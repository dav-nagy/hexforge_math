...
#define _math_egamma_f 0.577215671539306640625f

///φ (Phi), the Golden Ratio, defined as (1 + sqrt(5)) / 2.
#define _math_phi_f 1.61803400516510009766f
